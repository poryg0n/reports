...
\footnotesize
\begin{align}
\int C^{\omega}_{0k} p_{0k}a_k dk & =\int dk  \frac{e^{i(E_0+\omega-E_k)T}}{E_0+\omega-E_k} p_{0k}a_k \frac{dk}{2\pi}\nonumber\\
\int C^{\omega}_{kk^\prime} p_{kk^\prime}a_{k^\prime} & = \int dk^\prime \frac{e^{i(E_k+\omega-E_{k^\prime})T}}{E_k+\omega-E_{k^\prime}} 
p_{kk^\prime} a_{k^\prime} \frac{dk^\prime}{2\pi}   \nonumber
\end{align}
}
\end{minipage}
}
